resource "aws_api_gateway_integration_response" "main_api_v1_proxy_options_200" {
  ...
  status_code = aws_api_gateway_method_response.main_api_v1_proxy_options_200.status_code
